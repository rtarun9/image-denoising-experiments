...
def train_model(training_dataset, epochs, trained_model_file_name, history_file_name):        
    ...
    history = model.fit(train_dataset, epochs=epochs,  verbose=1, validation_data=val_dataset, callbacks=[checkpoint], batch_size=4)
...
def main():
    training_dataset = load_training_tf_dataset(low_dose_ct_training_dataset_dir='../../Dataset/LowDoseCTGrandChallenge/Training_Image_Data', load_as_patches=True, load_limited_images=True, num_images_to_load=4000)
