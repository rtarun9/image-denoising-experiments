...
class HformerModel(tf.keras.Model):
    def __init__(self, num_channels_to_be_generated, name):
        ...
        self.hformer_block_1 = HformerBlock(maxpool_kernel_size=2, attention_scaling_factor=4, num_channels=num_channels_to_be_generated * 2, name="hformer_block_1")
        self.hformer_block_2 = HformerBlock(maxpool_kernel_size=2, attention_scaling_factor=8, num_channels=num_channels_to_be_generated * 4, name="hformer_block_2")
        self.hformer_block_3 = HformerBlock(maxpool_kernel_size=2, attention_scaling_factor=16, num_channels=num_channels_to_be_generated * 2, name="hformer_block_3")
