...
class ZModel(torch.nn.Module):
    def __init__(self, num_channels,width=64, height=64):
        ...
        self.hformer_block_2 = ZBlock(maxpool_kernel_size=(2,2), attention_scaling_factor=1, num_channels=num_channels * 4, width=width // 4, height=height // 4)
        self.hformer_block_3 = ZBlock(maxpool_kernel_size=(2,2), attention_scaling_factor=1, num_channels=num_channels * 2, width=width // 2, height=height // 2)
